...
[![R](https://img.shields.io/badge/R-%3E%3D%204.0-blue)]() [![License:
GPL v3](https://img.shields.io/badge/License-GPLv3-blue.svg)]()
[![Bioconductor](https://img.shields.io/badge/Bioconductor-devel-green)]()
[![Build
Status](https://github.com/egaffo/ccp2tools/actions/workflows/R-CMD-check.yaml/badge.svg)]()

------------------------------------------------------------------------

## Overview

**ccp2tools** provides utility functions for analyzing circRNA
expression data generated by the
[CirComPara2](https://github.com/egaffo/circompara2) pipeline.\
It simplifies importing results into R and combining multiple
CirComPara2 runs or projects.
...
In addition, it allows combining multiple CirComPara2 projects or runs.
For instance, when you split your dataset into multiple batches to be
processed with CirComPara2, or you use
[ccp2_nf](https://github.com/egaffo/ccp2_nf), the Nextflow interface to
run CirComPara2.\
